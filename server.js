...
const API_URL = "https://bomaydangcap-vlemoi-kk.onrender.com/";
...
app.get("/taixiu", async (req, res) => {
    try {
        ...
        res.json({ id: "AnhHuydzai Sunwin", phien_truoc: 0, xuc_xac1: 0, xuc_xac2: 0, xuc_xac3: 0, tong: 0, ket_qua: "tài", pattern: "[Đang kết nối...]", phien_hien_tai: 0, du_doan: "tài", do_tin_cay: "52%" });
    }
});
